const input = +require('fs').readFileSync('Q17478/input.txt').toString()
console.log('어느 한 컴퓨터공학과 학생이 유명한 교수님을 찾아가 물었다.')
const recursiveQuestion = (input, line) => {
